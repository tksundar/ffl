...
urlpatterns += [path("<int:user_id>/registrations", views.registrations, name='registrations'), ]
urlpatterns += [path("<int:user_id>/deleted_view", views.deleted_view, name='deleted_view'), ]
...
urlpatterns += [path("<int:user_id>/upload", views.upload, name='upload'), ]
urlpatterns += [path("display_media", views.display_media, name='display_media'), ]
urlpatterns += [path("delete", views.delete_media, name='delete_media'), ]
